...
Window: 2021-01-01 -> 2023-12-31  |  Generated: 2026-06-12 00:26 UTC

> **WARNING: fees disabled - verification run only, not evidence.**

## Headline

- **Expectancy per trade (after fees): -4.79%** **[STATISTICALLY WEAK: 1 trades < 30]**
- Trades: 1 (below 30 - every metric here is weak evidence)
- Win rate: 0.00%  |  Avg win: n/a  |  Avg loss: -4.79%

## Risk and return

- Strategy total return: -0.51%  |  CAGR: -0.17%
- Max drawdown: -2.51%
- Time in market: 4.38%
...
- Strategy return -0.51% vs HODL 46.19%; strategy drawdown -2.51% vs HODL -76.63%
